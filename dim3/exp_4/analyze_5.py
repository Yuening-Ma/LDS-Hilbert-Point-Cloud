...
ANALYZE5_DIR = f'dim_3/7_stanford_all/analyze5_M{M}/'
...
# 保存比值统计结果
output_filename_ratio = f"{ANALYZE5_DIR}/exp5_stats_ratio.csv"
...
# 保存原始值统计结果
output_filename_values = f"{ANALYZE5_DIR}/exp5_stats.csv"
...
# 保存大于参考方法的比例统计结果
output_filename_greater = f"{ANALYZE5_DIR}/exp5_stats_greater.csv"
