...
M = 'flexible' # 根据analyze_step2_0312.py设置为'flexible'
SAMPLE_RATIO = 20 # 采样率 %
ALPHA = 0.05 # 显著性水平

# 目录设置，根据8_modelnet_2实验结构
DATA_DIR = f'datasets/ModelNet40_2/'
ANALYZE2_DIR = f'dim_3/8_modelnet_2/analyze2_M{M}/{SAMPLE_RATIO}/'
OUTPUT_DIR = f'dim_3/8_modelnet_2/paired_t_test/'
